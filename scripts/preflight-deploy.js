...
const REQUIRED_PATHS = [
  ...
  'api/bdr-workload.js',
  'api/bdr-workload-config.js',
  'api/bdr-workload-semantic.js',
  'api/bdr-workload-penetration.js',
  'api/bdr-workload-compare.js',
  'api/bdr-workload-drill.js',
  'api/bdr-workload-calls.js',
  'api/config-global.js',
  'public/bdr-workload.html',
  'public/bdr-workload-v2-core.js',
  'public/bdr-workload-v2-charts.js',
  'public/bdr-workload-v2.js',
  'scripts/test-bdr-workload-v2-ui.js',
  'lib/env.js',
