...
// Fase 2 do Dashboard 2.0: pipes vêm da camada semântica (fonte única).
const semantic = require('./semantic');

const PIPELINE_VENDAS = semantic.PIPELINES.vendas;
const PIPELINE_BID    = semantic.PIPELINES.bid;
