...
function mapFotoDeal(r) {
  ...
  return {
    ...
    arr_estimado: (function () {
      ...
      // problema do CFO, o forecast reflete crença). Espelha api/forecast-table.js — POC
      // flui pela mesma cascata de ARR de qualquer outro deal, sem guard especial.
    ...
    is_poc: _bool(r['É POC?']),   // fotos a partir de 2026-07-13 capturam É POC? — segue alimentando o zero de Real/Probabilizada do dealMonthly (forecast-engine.js), fora do escopo desta reversão (só ARR)
  };
}
