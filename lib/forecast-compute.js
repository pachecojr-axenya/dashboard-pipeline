...
function mapFotoDeal(r) {
  ...
  return {
    ...
    arr_estimado: (function () {
      // POC não estima ARR (2026-07-28): espelha api/forecast-table.js — POC zera em todos
      // os painéis (Regra primária nº 3 / dealMonthly), inclusive na coluna ARR Est. e nos
      // KPIs de ARR do Delta. Só dispara em fotos que capturam "É POC?" (a partir de 2026-07-13).
      if (_bool(r['É POC?']) === true) return null;
