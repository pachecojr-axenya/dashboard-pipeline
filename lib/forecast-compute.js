...
function drillRow(contribA, contribB, rowKey, measure) {
  ...
  const rows = Object.keys(ids).map(id => {
    ...
    return { id, dealname: (b || a).dealname, stageA: a ? a.stage : null, stageB: b ? b.stage : null, aCash, bCash, delta: bCash - aCash, tipo };
  });
