...
/**
 * BOOLEAN do BigQuery REST vem como STRING `"true"` / `"false"`.
 * `!"false"` é `false`, então testar o valor cru inverte a lógica em silêncio —
 * mesma família do gotcha de TIMESTAMP-em-epoch acima. Custou um filtro que
 * derrubou 2.944 de 3.479 toques por achar que todos eram atribuídos.
 */
function bool(v) {
...
module.exports = {
  ...
  t, cotacaoOnly, timestamp, bool, num, str, ymd, isConfigured, query,
};
