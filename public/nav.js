...
(function () {
  ...
  if (!document.getElementById('nav-shared-css')) {
    ...
    st.textContent = [
      ...
      '.health-dot.g{background:var(--green);--hg:rgba(46,204,113,.95)}',
      '.health-dot.y{background:var(--yellow);--hg:rgba(241,196,15,.95)}',
      '.health-dot.r{background:var(--red);--hg:rgba(231,76,60,.95)}',
  ...
  var PANELS = [
    ...
    // 24/08/2026: sai de amarelo. O amarelo dizia "novo | em auditoria" e a auditoria
    // fechou — 9/9 métricas de ritmo e desfecho com delta ZERO contra o medallion
    // (compare-workload-sources.js), e as duas camadas passaram a rodar intraday
    // (armazém 6x/dia; medallion 10h/15h/20h). O que resta é WARN declarado na tela,
    // não incerteza sobre o número.
    {label:'Workload | Intraday',url:'/novo-bdr/workload',file:'bdr-workload.html',sub:'bdr',health:'g',icon:'<path d="M22 12h-4l-3 9L9 3l-3 9H2"/>'},
    ...
    {label:'Ataque à Lista',url:'/novo-bdr/list-attack',file:'bdr-list-attack.html',sub:'bdr',health:'r',icon:'<line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/>'},
    {label:'Treble',url:'/novo-bdr/treble',file:'bdr-treble.html',sub:'bdr',health:'g',icon:'<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>'},
    ...
    {label:'Delta',url:'/forecast-delta',file:'forecast-delta.html',health:'g',icon:'<line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/>'},
