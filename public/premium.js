...
(function () {
  ...
  var NAV_MODEL = [
    ...
    // 24/08/2026: verde. Auditoria fechou (9/9 delta zero) e as duas camadas viraram
    // intraday. Mantido em sincronia com public/nav.js — as duas listas de menu ainda
    // coexistem, e selo divergente entre elas é pior que selo errado.
    { href: '/novo-bdr/workload', label: 'Workload | Intraday', health: 'g', sub: true, grp: 'bdr', svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>' },
    ...
    { href: '/growth/seo', label: 'SEO', health: 'g', sub: true, grp: 'growth', svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/></svg>' },
  ...
  function buildCanonicalNav() {
    ...
    if (current === '/dashboard/growth/seo' || current === '/seo-performance' || page === 'seo-performance') current = '/growth/seo';
