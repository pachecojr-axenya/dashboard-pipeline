...
(function () {
  ...
  var NAV_MODEL = [
    ...
    { href: '/novo-bdr/no-show', label: 'BDR | No Show', svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M7 15l4-4 3 3 5-7"/><circle cx="11" cy="11" r="1"/><circle cx="14" cy="14" r="1"/></svg>' },
