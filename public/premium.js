...
(function () {
  ...
  var NAV_MODEL = [
    ...
    { href: '/novo-board', label: 'Board View', svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h20M4 20V10l8-6 8 6v10"/><path d="M10 20v-6h4v6"/></svg>' },
    { href: '/novo-ae', label: 'AE Performance', svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>' },
    { href: '/novo-bdr', label: 'BDR Performance', svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>' },
    { href: '/dashboard/bdr/no-show', label: 'No Show BDR', svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M7 15l4-4 3 3 5-7"/><circle cx="11" cy="11" r="1"/><circle cx="14" cy="14" r="1"/></svg>' },
    { href: '/novo-48h', label: 'Last 48h', svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>' },
  ...
  function buildCanonicalNav() {
    ...
    if (current === '/novo-bdr-no-show' || page === 'bdr-no-show') current = '/dashboard/bdr/no-show';
    ...
    NAV_MODEL.forEach(function (it) {
      ...
      html += '<li class="nav-item' + (active ? ' active' : '') + '" data-href="' + it.href + '"' +
        (active ? ' aria-current="page"' : '') + '>' + it.svg + it.label + '</li>';
    });
    menu.innerHTML = html;
