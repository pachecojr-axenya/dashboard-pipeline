...
const LIVE_RHYTHM_FIELDS = ['calls', 'callsConversation', 'callsDial', 'emails', 'whatsapp', 'whatsappManual', 'whatsappTreble', 'linkedin', 'meetings', 'activities', 'total'];
...
function parse(req) {
  ...
  return { since, until, bdr, channels, businessDays: q.get('businessDays') !== 'false', portes, segmentos, personas, porte: portes[0] || null, segmento: segmentos[0] || null, persona: personas[0] || null, refresh: q.get('refresh') === '1' };
}
