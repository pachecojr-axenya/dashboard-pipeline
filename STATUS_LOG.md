...
5. **Só UMA sessão deploya**, e somente quando as outras confirmarem "terminei e validei". O deploy sobe trabalho pela metade de todo mundo. Endpoint NOVO em `api/` → checar antes o limite de 12 funções serverless do plano Hobby (deploy inteiro falha se estourar).
